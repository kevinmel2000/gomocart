...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        user data = CommonUtilities.getSettingUser(getApplicationContext());
        if(data.getId()>0) {
    ...
    class prosesUpdateRegisterRegId extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... urls) {
            return ServerUtilities.register(getApplicationContext(), registrationId, data.getId(), CommonUtilities.getGuestId(getApplicationContext()));
        }
